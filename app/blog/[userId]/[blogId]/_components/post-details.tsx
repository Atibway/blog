...
import { Chapter, Comment, Course } from "@prisma/client";
...
export  function PostDetail({
  ...
  return (
    <>
    <p className={twMerge( "text-2xl mb-4 text-center capitalize")}>
            {blog.title}
          </p>
...
<Footer
  url={`https://fcblog-two.vercel.app/blog/${blog?.userId}/${blog?.id}`}
  title="Blog Post"
